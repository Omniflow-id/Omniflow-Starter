...
function applyTopPadding() {
  ...
  document.querySelectorAll(".bs-sidebar.affix").forEach((sidebar) => {
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  var search_modal = new bootstrap.Modal(
    document.getElementById("mkdocs_search_modal")
  );
  var keyboard_modal = new bootstrap.Modal(
    document.getElementById("mkdocs_keyboard_modal")
  );
  ...
  document
    .getElementById("mkdocs_search_modal")
  ...
  function showInnerDropdown(item) {
    ...
    container
      .querySelectorAll(":scope > .dropdown-submenu > a")
      .forEach((el) => {
        if (el !== item) {
    ...
    if (
      bounds.top + popup.clientHeight > maxBottom &&
  ...
  document.querySelectorAll(".dropdown-menu").forEach((menu) => {
    menu.parentElement.addEventListener("hide.bs.dropdown", () => {
      menu.scrollTop = 0;
